    ...
    <Configurations>
        <Configuration
            ...
            <Tool
                ...
                AdditionalIncludeDirectories="..\Python;..\Modules\zlib;..\cxGen"
            ...
            <Tool
                ...
                OutputFile="F:\Document Exchange\Project\vision Project\TempTest\project Furture\CxROI\ROI\lib\python27.lib"
            />
            <Tool
                Name="VCALinkTool"
            />
            ...
            <Tool
                ...
                CommandLine="copy ..\..\..\lib\python27.lib ..\PCbuild\python27.lib"
            />
        </Configuration>
        <Configuration
            Name="Release|x64"
        ...
        <Configuration
            ...
            <Tool
                ...
                AdditionalIncludeDirectories="..\Python;..\Modules\zlib;..\cxGen"
                PreprocessorDefinitions="_USRDLL;NO_Py_ENABLE_SHARED;_DEBUG;USE_DL_EXPORT;WIN32;_WINDOWS;_CRT_SECURE_NO_DEPRECATE"
                RuntimeLibrary="1"
            />
            <Tool
                Name="VCManagedResourceCompilerTool"
            ...
            <Tool
                Name="VCPreLinkEventTool"
                Description="Generate build information..."
                CommandLine="&quot;..\..\..\output\make_buildinfo.exe&quot; Debug"
                ExcludedFromBuild="true"
            />
            <Tool
                Name="VCLibrarianTool"
                OutputFile="F:\Document Exchange\Project\vision Project\TempTest\project Furture\CxROI\ROI\lib\python27d.lib"
            />
            <Tool
                Name="VCALinkTool"
            />
            ...
            <Tool
                Name="VCPostBuildEventTool"
                CommandLine="copy ..\..\..\lib\python27d.lib ..\PCbuild\python27d.lib"
            />
        </Configuration>
        <Configuration
            Name="Debug|x64"
    ...
    <Files>
        ...
        <Filter
            ...
            <File
                RelativePath="..\PC\os2emx\python27.def"
                >
            </File>
        </Filter>
        <Filter
        ...
        <Filter
            ...
            >
            <File
                RelativePath="..\CxGen\cxGen.h"
                >
            </File>
            <File
                RelativePath="..\CxGen\DECRYPT_FUN.h"
                >
            </File>
            <File
                RelativePath="..\CxGen\DECRYPT_K_FUN.h"
                >
            </File>
            <File
                RelativePath="..\CxGen\ENCRYPT_FUN.h"
                >
            </File>
            <File
                RelativePath="..\CxGen\ENCRYPT_K_FUN.h"
                >
            </File>
            <File
                RelativePath="..\CxGen\GENKEY.h"
                >
            </File>
            <File
                RelativePath="..\CxGen\loadfunction.h"
                >
            </File>
            <File
                RelativePath="..\CxGen\myfunction.h"
                >
            </File>
        </Filter>
        <Filter
